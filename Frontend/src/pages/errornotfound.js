...
function Errornotfound() {
    ...
    return (
      <body className="zebi1">
      <div className="zebi2">
          <svg className="zebi3" width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="zebi2">
          <h1 className="zebi4">404 Error</h1>  
        <h2>Couldn't Find Your Friend :(</h2>
           <h3>Page Not Found - lets take you Back  <Link to={"/"}>Home</Link></h3> 
      </div>
  </body>
  )
}
